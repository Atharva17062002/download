...
import 'package:download/data.dart';
import 'package:download/download_list_item.dart';
...
class _MyHomePageState extends State<MyHomePage> {
        ...
        Row(
          children: [
            Checkbox(
              ...
              onChanged: (newValue) {
                // setState(() => _saveInPublicStorage = newValue ?? true);
              },
            ),
  ...
  Future<List<Directory?>> get _dirsOnIOS async {
    final temporary = (await DownloadsPath.downloadsDirectory());
